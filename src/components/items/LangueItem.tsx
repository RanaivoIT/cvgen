...
import LangueFrom from "../forms/LangueForm"

const LangueItem = ({ id, langue, niveau }: any) => {
    ...
    return (
        ...
        <div className="card mb-2">
            ...
            <div className={(hidden) ? 'd-none' : 'card-header'}>
                ...
                <div className="d-flex justify-content-between align-items-center">
                    ...
                    <div className="content">
                        ...
                        <button className="btn btn-outline-danger" type="button" onClick={onDeleteLangue}>
            ...
            <div className={(hidden) ? 'card-body' : 'd-none'}>
                <LangueFrom id={id} langue={langue} niveau={niveau} onShowForm={onShowForm} />
            </div>
